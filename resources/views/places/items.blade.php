                        ...
                        <div class="">
                            <div class="sm:flex sm:items-center">
                                <div class="sm:flex-auto">
                                    <h1 class="text-base font-semibold leading-6 text-gray-900">Listes des Équipements
                                        de
                                        {{ $place->name }} </h1>
                                    <p class="mt-2 text-sm text-gray-700">Une liste des tous les équipements IT se
                                        situant à
                                            ...
                                            <button type="submit" class="absolute right-0 top-0 mt-2 mr-2">
                                                <svg class="h-5 w-5 text-gray-400" viewBox="0 0 20 20"
                                                    ...
                                                    <path fill-rule="evenodd"
                                                        d="M8.5 3a5.5 5.5 0 100 11 5.5 5.5 0 000-11zm0 1a4.5 4.5 0 110 9 4.5 4.5 0 010-9zM14 14a1 1 0 10-1.414-1.414l-3.182 3.182a1 1 0 001.414 1.414l3.182-3.182a1 1 0 000-1.414z"
                                                        clip-rule="evenodd" />
                                                </svg>
                                            </button>
                                        </div>
