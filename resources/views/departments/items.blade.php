<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Équipements du département ') . $department->name }}
        </h2>
    </x-slot>
                    ...
                    <div class="">
                        <div class="sm:flex sm:items-center">
                            <div class="sm:flex-auto">
                                <h1 class="text-base font-semibold leading-6 text-gray-900">Liste de
                                    {{$department->name}} </h1>
                                <p class="mt-2 text-sm text-gray-700">Une liste des tous les équipements associé au département :  {{$department->name}}</p>
                            </div>
