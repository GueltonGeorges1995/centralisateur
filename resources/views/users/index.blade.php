                    ...
                    <div class="">
                        <div class="sm:flex">
                            <div class="sm:flex-auto">
                                <h1 class="text-base font-semibold leading-6 text-gray-900">Listes des utilisateurs</h1>
                                <p class="mt-2 text-sm text-gray-700">Une liste des tous les utilisateurs</p>
                            </div>
                                            ...
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm sm:pr-0">
                                                        <a href="{{ route('users.show', $user->id) }}" class="text-indigo-600 hover:text-indigo-900">Voir plus<span class="sr-only"> Voir plus</span></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
