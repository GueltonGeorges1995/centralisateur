<section class="space-y-6">
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Supprimer un local') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __('Une fois un local supprimé, tous les items seront supprimés aussi. .') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('subplaces.destroy', $subplace) }}" class="p-6">
        @csrf
        @method('delete')
